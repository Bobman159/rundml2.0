...
/**
 * Default implementation of IConnectionPool for the purpose of obtaining, releasing 
 * and the closing of JDBC connections and the connection pool itself.  One instance of 
 * DefaultConnectionPool is needed for each instance of a defined connection pool.
 * 
 * @see com.bobman159.rundml.jdbc.pool.PoolFactory
 * @see com.bobman159.rundml.jdbc.pool.IConnectionPool
 * @author Robert Anderson
 *
 */
public class DefaultConnectionPool implements IConnectionPool {

	private boolean poolTracing = false;
	private HikariDataSource dataSource = null;
	private Logger logger = LogManager.getLogger(DefaultConnectionPool.class);
	 ...
	 */
	public DefaultConnectionPool(HikariDataSource source) {
		dataSource = source;
	}
	
	/**
	 * @see com.bobman159.rundml.jdbc.pool.IConnectionPool#getConnection()
	 */
	@Override
...
//                System.exit(0);
	...
	/**
	 * @see com.bobman159.rundml.jdbc.pool.IConnectionPool#releaseConnection(Connection)
	 */
	@Override
	...
	/**
	 * @see com.bobman159.rundml.jdbc.pool.IConnectionPool#closePool()
	 */
	@Override
	...
	/**
	 * @see com.bobman159.rundml.jdbc.pool.IConnectionPool#setPoolConnectionTrace(boolean)
	 */
	@Override 
