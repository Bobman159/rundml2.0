package com.bobman159.rundml.mysql.select.builder.tests;
...
class MySQLSelectSyntaxTests {
	...
	void mySQLOffsetTest() {
		...
		Assert.assertEquals("select * " + FROM_CLAUSE_SPACE + "limit 5 offset 1",stmtText);
	...
	void mySQLLimitTest() {
		...
		Assert.assertEquals("select * " + FROM_CLAUSE_SPACE + "limit 5",stmtText);
	...
	void mySQLAllTest() {
		...
		Assert.assertEquals("select all DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
	...
	void mySQLDistinctTest() {
		...
		Assert.assertEquals("select distinct DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
...
//		VALID
		...
		Assert.assertEquals("select sql_small_result DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
...
//		INVALID 	
		...
		Assert.assertEquals("select NOTNULLVARCHAR sql_small_result " +
							FROM_CLAUSE,stmtText2);
...
//		VALID
		...
		Assert.assertEquals("select sql_big_result DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
...
//		INVALID
		...
		Assert.assertEquals("select NOTNULLVARCHAR sql_big_result " +
							FROM_CLAUSE,stmtText2);
...
//		VALID
		...
		Assert.assertEquals("select sql_buffer_result DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
...
//		VALID? - Executed ok in rundml db
		...
		Assert.assertEquals("select NOTNULLVARCHAR sql_buffer_result " +
							FROM_CLAUSE,stmtText2);
