package com.bobman159.rundml.mysql.mocktables;
...
public class TypeTest implements ITableRow {
	...
	Integer				DfltTinyInt;
	Short				NotNullSmint;
	BigDecimal			NotNullDec72;
	Time				NotNullTime;
	Date				NotNullDate;
	Timestamp			NotNullTimestamp;
	Timestamp			NotNullDateTime;
	String				NotNullVarchar;
	String				NotNullChar;
	Blob				NotNullBlob;
	Clob				NotNullText;
	Boolean				NotNullBit;
	...
	public Integer getDfltIntUnsigned() {
		return DfltIntUnsigned;
	}
	public Integer getDfltTinyInt() {
		return DfltTinyInt;
	}
