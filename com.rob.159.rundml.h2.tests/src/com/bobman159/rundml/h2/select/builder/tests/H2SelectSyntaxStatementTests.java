...
class H2SelectSyntaxStatementTests {
	...
	void h2SelectTopTest() {
		...
		Assert.assertEquals("select top 5 DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
		...
		Assert.assertEquals("select top '0123456789' NOTNULLVARCHAR " +
	...
	void h2SelectTopDistinctTest() {
		...
		Assert.assertEquals("select top 5 distinct DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
		...
		Assert.assertEquals("select top '0123456789' distinct NOTNULLVARCHAR " +
							FROM_CLAUSE,stmtText2);
	...
	void h2SelectTopAllTest() {
		...
		Assert.assertEquals("select top 5 all DFLTINTEGER " +
							FROM_CLAUSE,stmtText);
		...
		Assert.assertEquals("select top '5' all NOTNULLVARCHAR " +
							FROM_CLAUSE,stmtText2);
