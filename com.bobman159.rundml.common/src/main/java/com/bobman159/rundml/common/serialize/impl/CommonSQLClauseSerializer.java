...
/**
 * Common class to serialize SQL clauses in different SQL statements.
 *
 */
public class CommonSQLClauseSerializer extends SQLTypeSerializer {
	
	private static CommonSQLClauseSerializer self;
	
	/**
	 * 
	 * @return an instance of the base SQL serializer.
	 */
	public static CommonSQLClauseSerializer getInstance() {
		if (self == null) {
			self = new CommonSQLClauseSerializer();
		}
		return self;
	}
	
	private CommonSQLClauseSerializer() {
		//Do nothing
	}
	 ...
	 */
	public String serializeOrderBy(List<IOrderByEntry> orderBys) {
